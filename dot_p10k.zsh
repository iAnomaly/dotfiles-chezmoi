# Generated by Powerlevel10k configuration wizard on 2019-07-31 at 14:29 PDT.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 18812.
# Wizard options: compatible, classic, darkest, blurred tails, 2 lines, solid,
# right frame, sparse, fluent.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION='${P9K_KUBECONTEXT_CLOUD_CLUSTER:-${P9K_CONTENT}}'
